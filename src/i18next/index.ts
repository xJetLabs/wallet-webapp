...
const resources = {
  en: {
    translation: {
      ...
      "Received from User":"Received from User",
      "Cheque activation":"Cheque activation",
      "Cheque created":"Cheque created",
      "Fire jetton in chat":"Fire jetton in chat",
      "Payment for invoice":"Payment for invoice",
      "Invoice payment":"Invoice payment",
      "Jetton swap":"Jetton swap",
      "Cheque delete":"Cheque delete",
      "Loading":"Loading",
      "buy":"buy",
      "sell":"sell",
  ...
  ru: {
    translation: {
      ...
      "Sent to api":"Отправка на api",
      "Received":"Получено",
      "Transfer to wallet":"Перевод на кошелек",
      "Sent to User":"Отправлено пользователю",
      "Received from User":"Получено от пользователя",
      "Cheque activation":"Активация чека",
      "Cheque created":"Создание чека",
      "Fire jetton in chat":"Раздача жетонов в чате",
      "Payment for invoice":"Оплата за счет",
      "Invoice payment":"Оплата счета ",
      "Jetton swap":"Обмен жетонов",
      "Cheque delete":"Удаление чека",
      "Loading":"Загрузка",
      "buy":"купить",
      "sell":"продать",
